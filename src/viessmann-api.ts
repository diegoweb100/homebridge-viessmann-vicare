...
// 🆕 NUOVA SEZIONE per nomi personalizzati
  ...
  // Report web server
  reportServerPort?: number;   // 0 = disabled, e.g. 3001
  reportServerPath?: string;   // Homebridge data path (default: /var/lib/homebridge)
...
export class ViessmannAPI {
  ...
  constructor(
    ...
    // Initialize auth manager — pass storagePath for Homebridge-compliant file storage
